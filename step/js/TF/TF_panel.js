	...
	TF_panel.prototype.addContextMenu = function( options ) {
		...
		function showContextMenu( e ) {
			var mouse = TF_UI.getRelativePosition( e.clientX, e.clientY, container );
	...
	TF_panel.prototype.setHistogram = function( histogram ) {
		...
		this.panel.svgContext.addEventListener( 'mousemove', function ( e ) {
			var mouse = TF_UI.getRelativePosition( e.clientX, e.clientY, self.panel.dom );
	...
	TF_widget.prototype.createAnchor = function() {
		...
		function moveAnchor( e ) {
			e.preventDefault();
			e.stopPropagation();
			var mouse = TF_UI.getRelativePosition( e.clientX, e.clientY, parent.dom );
	...
	TF_widget.prototype.addControlPoint = function( value, alpha, color ) {
		...
		function moveHandle( e ) {
			var mouse = TF_UI.getRelativePosition( e.clientX, e.clientY, this.container );
